...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.closeButton.setGeometry(QtCore.QRect(170, 290, 191, 61))
        self.closeButton.setObjectName("closeButton")
        self.openButton = QtWidgets.QPushButton(self.centralwidget)
        self.openButton.setGeometry(QtCore.QRect(200, 350, 131, 61))
        self.openButton.setObjectName("openButton")
        self.secondOpenButton = QtWidgets.QPushButton(self.centralwidget)
        self.secondOpenButton.setGeometry(QtCore.QRect(220, 410, 101, 61))
